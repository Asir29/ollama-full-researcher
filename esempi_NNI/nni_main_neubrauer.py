...
### REMEMBER: the "alpha_(...)" hyperparameters are needed only if synaptic neurons are used
search_space = {
    'neurons_per_pop': {'_type': 'choice', '_value': [2, 4, 8, 16]}, # use it as an int in the script
    'output_pop': {'_type': 'choice', '_value': [1, 2, 4, 8, 16]}, # use it as an int in the script
    'nb_hidden': {'_type': 'choice', '_value': [16, 32, 64]}, # use it as an int in the script
    'alpha_hid': {'_type': 'quniform', '_value': [0, 1, 0.05]},
    'alpha_out': {'_type': 'quniform', '_value': [0, 1, 0.05]},
    'beta_hid': {'_type': 'quniform', '_value': [0, 1, 0.05]},
    'beta_out': {'_type': 'quniform', '_value': [0, 1, 0.05]},
    'beta_enc': {'_type': 'quniform', '_value': [0, 1, 0.05]},
    'lr': {'_type': 'choice', '_value': [0.0001, 0.00015, 0.0005, 0.001, 0.0015, 0.002, 0.005, 0.01, 0.1]},
    'reg_l1': {'_type': 'quniform', '_value': [0, 1e-2, 1e-4]},
    'reg_l2': {'_type': 'quniform', '_value': [0, 1e-4, 1e-6]},
...
if __name__ == '__main__':
    ...
    parser.add_argument('-exp_name',
                        type=str,
                        default='braille_letters_digits_40Hz_augmented_populations',
